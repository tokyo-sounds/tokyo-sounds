...
export const TOKYO_SPATIAL_AUDIO_SOURCES: SpatialAudioSource[] = [
  ...
  // === Parks ===
  {
    ...
    lng: 139.7741,
    alt: 20,
    src: "/audio/ambient-sounds/朝の住宅音.m4a",
    volume: 0.3,
    refDistance: 20,
    maxDistance: 150,
    loop: true,
  ...
  // === Rivers ===
  {
    ...
    lng: 139.8016,
    alt: 3,
    src: "/audio/nature/20215-12-11-souns-川の音.m4a",
    volume: 0.5,
    refDistance: 30,
    maxDistance: 250,
    loop: true,
  ...
  // === Markets ===
  {
    ...
    lng: 139.7749,
    alt: 4,
    src: "/audio/ambient-sounds/人の声.m4a",
    volume: 0.5,
    refDistance: 35,
    maxDistance: 200,
    loop: true,
  },
  {
    ...
    lng: 139.7706,
    alt: 3,
    src: "/audio/ambient-sounds/人の音.m4a",
    volume: 0.5,
    refDistance: 35,
    maxDistance: 200,
    loop: true,
  ...
  },
  {
    ...
    lng: 139.7007,
    alt: 38,
    src: "/audio/ambient-sounds/車の音2.m4a",
    volume: 0.6,
    refDistance: 50,
    maxDistance: 400,
    loop: true,
  ...
  // === Construction Areas ===
  {
    ...
    lng: 139.6995,
    alt: 35,
    src: "/audio/ambient-sounds/車の音.m4a",
    volume: 0.5,
    refDistance: 40,
    maxDistance: 300,
    loop: true,
