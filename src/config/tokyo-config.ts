...
export const TOKYO_SPATIAL_AUDIO_SOURCES: SpatialAudioSource[] = [
  ...
  // // === Parks ===
  // {
  //   id: "ueno_park_birds_1",
  //   name: "Ueno Park Bird Songs",
  //   nameJa: "上野恩賜公園 鳥の声",
  //   lat: 35.7153,
  //   lng: 139.7741,
  //   alt: 20,
  //   src: "/audio/ambient-sounds/20215-12-11-souns-朝の住宅音.m4a",
  //   volume: 0.3,
  //   refDistance: 20,
  //   maxDistance: 150,
  //   loop: true,
  // },
  // {
  //   id: "yoyogi_park_birds",
  //   name: "Yoyogi Park Bird Songs",
  //   nameJa: "代々木公園 鳥の声",
  //   lat: 35.6718,
  //   lng: 139.6951,
  //   alt: 33,
  ...
  // // === Rivers ===
  // {
  //   id: "sumida_river_flow",
  //   name: "Sumida River Flow",
  //   nameJa: "隅田川 水の流れ",
  //   lat: 35.7115,
  //   lng: 139.8016,
  //   alt: 3,
  //   src: "/audio/ambient-sounds/20215-12-11-souns-川の音.m4a",
  //   volume: 0.5,
  //   refDistance: 30,
  //   maxDistance: 250,
  //   loop: true,
  // },
  // {
  //   id: "tamagawa_river_flow",
  //   name: "Tamagawa River Flow",
  //   nameJa: "多摩川 水の流れ",
  //   lat: 35.6722,
  //   lng: 139.4275,
  //   alt: 18,
  ...
  // // === Markets ===
  // {
  //   id: "ameyoko_market_chatter",
  //   name: "Ameyoko Market Chatter",
  //   nameJa: "アメ横 雑音",
  //   lat: 35.7093,
  //   lng: 139.7749,
  //   alt: 4,
  //   src: "/audio/ambient-sounds/20215-12-11-souns-人の雑音.m4a",
  //   volume: 0.5,
  //   refDistance: 35,
  //   maxDistance: 200,
  //   loop: true,
  // },
  // {
  //   id: "tsukiji_market_chatter",
  //   name: "Tsukiji Market Chatter",
  //   nameJa: "築地場外市場 雑音",
  //   lat: 35.6653,
  //   lng: 139.7706,
  //   alt: 3,
  ...
  // // === Traffic ===
  // {
  //   id: "shibuya_crossing_ambience",
  //   name: "Shibuya Crossing Ambience",
  //   nameJa: "渋谷 crossing 雑音",
  //   lat: 35.6595,
  //   lng: 139.7004,
  //   alt: 15,
  //   src: "/audio/ambient-sounds/20215-12-11-souns-人の雑音.m4a",
  ...
  // {
  //   id: "shinjuku_traffic",
  //   name: "Shinjuku Traffic",
  //   nameJa: "新宿 交通音",
  //   lat: 35.6890,
  //   lng: 139.7007,
  //   alt: 38,
  //   src: "/audio/ambient-sounds/20215-12-11-souns-車の音2.m4a",
  //   volume: 0.6,
  //   refDistance: 50,
  //   maxDistance: 400,
  //   loop: true,
  ...
  // // === Commercial Areas ===
  // {
  //   id: "ginza_commercial_ambience",
  //   name: "Ginza Commercial Ambience",
  //   nameJa: "銀座 商業地区 雑音",
  //   lat: 35.6710,
  //   lng: 139.7649,
  //   alt: 3,
  ...
  // },
  // {
  //   id: "omotesando_commercial_ambience",
  //   name: "Omotesando Commercial Ambience",
  //   nameJa: "表参道 商業地区 雑音",
  //   lat: 35.6687,
  //   lng: 139.7060,
  //   alt: 30,
  ...
  // },
  // {
  //   id: "odaiba_beach_waves",
  //   name: "Odaiba Beach Waves",
  //   nameJa: "お台場 海の波音",
  //   lat: 35.6318,
  //   lng: 139.7774,
  //   alt: 4,
  ...
  // // === Construction Areas ===
  // {
  //   id: "shinjuku_west_construction",
  //   name: "Shinjuku West Construction",
  //   nameJa: "新宿西口 工事音",
  //   lat: 35.6917,
  //   lng: 139.6995,
  //   alt: 35,
  //   src: "/audio/ambient-sounds/20215-12-11-souns-ドライブ音.m4a",
  //   volume: 0.5,
  //   refDistance: 40,
  //   maxDistance: 300,
  //   loop: true,
  // },
  // {
  //   id: "torch_tower_construction",
  //   name: "Torch Tower Construction",
  //   nameJa: "トーチタワー 工事音",
  //   lat: 35.6853,
  //   lng: 139.7712,
  //   alt: 4,
  ...
  // },
  // {
  //   id: "nezu_shrine_quiet",
  //   name: "Nezu Shrine Ambience",
  //   nameJa: "根津神社 静けさ",
  //   lat: 35.7202,
  //   lng: 139.7607,
  //   alt: 18,
  ...
  // // === Shinjuku Specific Locations ===
  // {
  //   id: "familymart_kabukicho_door_chime",
  //   name: "FamilyMart Kabukicho Door Chime",
  //   nameJa: "ファミリーマート 蛇窪店 ドア音",
  //   lat: 35.6952,
  //   lng: 139.7007,
  //   alt: 20,
  //   src: "/audio/池袋/ファミマ.m4a",
  ...
  // },
  // {
  //   id: "toho_godzilla_building",
  //   name: "Toho Godzilla Building",
  //   nameJa: "東宝ゴジラビル",
  //   lat: 35.6953,
  //   lng: 139.7020,
  //   alt: 20,
  ...
  // },
  // {
  //   id: "donquijote_shinjuku_chaos",
  //   name: "Don Quijote Shinjuku Chaos",
  //   nameJa: "ドンキホーテ 新宿店 混雑音",
  //   lat: 35.6938,
  //   lng: 139.7018,
  //   alt: 20,
  //   src: "/audio/ambient-sounds/20215-12-11-souns-人の雑音.m4a",
  ...
  // },
  // {
  //   id: "taito_station_arcade_noise",
  //   name: "Taito Station Arcade Noise",
  //   nameJa: "タイトーステーション 電子音",
  //   lat: 35.6899,
  //   lng: 139.7023,
  //   alt: 20,
  //   src: "/audio/池袋/ゲームセンター.m4a",
  ...
  // },
  // {
  //   id: "omoide_yokocho_alley_sizzle",
  //   name: "Omoide Yokocho Alley Sizzle",
  //   nameJa: "思い出横丁 焼き肉音",
  //   lat: 35.6929,
  //   lng: 139.6998,
  //   alt: 20,
  ...
  // },
  // {
  //   id: "golden_gai_karaoke_muffle",
  //   name: "Golden Gai Karaoke Muffled",
  //   nameJa: "ゴールデン街 マuffled 歌声",
  //   lat: 35.6939,
  //   lng: 139.7047,
  //   alt: 20,
  //   src: "/audio/ambient-sounds/20215-12-11-souns-朝の住宅音.m4a",
  ...
  // },
  // {
  //   id: "busta_shinjuku_announcements",
  //   name: "Busta Shinjuku Announcements",
  //   nameJa: "バスタ新宿 放送",
  //   lat: 35.6888,
  //   lng: 139.7007,
  //   alt: 20,
  ...
  // },
  // {
  //   id: "busta_shinjuku_bus_engine",
  //   name: "Busta Shinjuku Bus Engine",
  //   nameJa: "バスタ新宿 バス音",
  //   lat: 35.6888,
  //   lng: 139.7007,
  //   alt: 20,
  ...
  // },
  // {
  //   id: "isetan_dept_store_upscale",
  //   name: "Isetan Dept Store Upscale",
  //   nameJa: "伊勢丹 発音",
  //   lat: 35.6916,
  //   lng: 139.7046,
  //   alt: 20,
  ...
  // },
  // {
  //   id: "kinokuniya_books_quiet",
  //   name: "Kinokuniya Books Quiet",
  //   nameJa: "紀伊國屋書店 静けさ",
  //   lat: 35.6920,
  //   lng: 139.7028,
  //   alt: 20,
  ...
  // },
  // {
  //   id: "hanazono_shrine_ritual",
  //   name: "Hanazono Shrine Ritual",
  //   nameJa: "花園神社 木の葉音",
  //   lat: 35.6936,
  //   lng: 139.7053,
  //   alt: 20,
  ...
  // },
  // {
  //   id: "toho_godzilla_roar",
  //   name: "Toho Godzilla Roar",
  //   nameJa: "東宝 ゴジラ音",
  //   lat: 35.6954,
  //   lng: 139.7021,
  //   alt: 20,
...
// Google Tiles API configuration
  ...
  // },
  // {
  //   id: "ueno_park_fountain",
  //   name: "Ueno Park Fountain",
  //   nameJa: "上野恩賜公園 水の音",
  //   lat: 35.7153,
  //   lng: 139.7741,
  //   alt: 20,
