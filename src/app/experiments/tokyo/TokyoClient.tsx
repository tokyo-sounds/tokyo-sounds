...
export default function TokyoClient({
  ...
  const effectiveLyriaApiKey = storeApiKey || lyriaApiKey;
    ...
    try {
      ...
      if (typeof DOE?.requestPermission === "function") {
        try {
          ...
          console.error(
            "[TokyoClient] Failed to request gyroscope permission:",
            e
          );
        }
      }
      ...
      if (typeof DME?.requestPermission === "function") {
        try {
          ...
          console.error(
            "[TokyoClient] Failed to request motion permission:",
            e
          );
        }
      }
    } catch (e) {
      console.error("[TokyoClient] Error requesting device permissions:", e);
    }
