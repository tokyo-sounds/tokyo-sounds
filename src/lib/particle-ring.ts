...
const MAX_RADIUS = 15;
const DEPTH = 2;
const LEFT_COLOR = "F2935C"; // the color of the left side points of the ring
const RIGHT_COLOR = "F25D50"; // the right color of the points of the ring
const NUM_POINTS = 2500; // the number of points of the ring
